  ...
  return (
    <Container className="pt-24 md:pt-32">
      ...
      <div className="flex items-center">
        <h1 className="mt-6 mb-6 text-4xl font-bold md:mt-8 md:mb-8 md:text-5xl text-dark-900 dark:text-light-900">
          {t("hero.title")}
        </h1>
        <HandWave className="text-4xl md:text-5xl" />
      </div>
      <p className="text-xl font-bold tracking-normal md:text-3xl text-dark-700 dark:text-light-700">
        {t("hero.p0")}
        <br />
      ...
      <div className="mt-10">
        <p className="mb-8 text-base md:text-xl dark:text-light-700 text-dark-700">
          {t("hero.des0")}
        </p>
        <p className="mb-8 text-base md:text-xl dark:text-light-700 text-dark-700">
          {t("hero.des1")}
